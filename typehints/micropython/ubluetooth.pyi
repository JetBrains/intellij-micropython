...
`https://raw.githubusercontent.com/micropython/micropython/master/docs/library/ubluetooth.rst`, etc.
...
class BLE:
   ...
   def gatts_write(self, value_handle: memoryview, data: bytes, /) -> None:
      """
