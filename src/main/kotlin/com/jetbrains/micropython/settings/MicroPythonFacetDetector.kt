...
class MicroPythonFacetDetector : FacetBasedFrameworkDetector<MicroPythonFacet, MicroPythonFacetConfiguration>("MicroPython") {
  override fun getFacetType(): FacetType<MicroPythonFacet, MicroPythonFacetConfiguration> {
    return MicroPythonFacetType.getInstance()
  }

  override fun createSuitableFilePattern(): ElementPattern<FileContent> {
    return FileContentPattern.fileContent().with(object : PatternCondition<FileContent>("Contains MicroPython imports") {
